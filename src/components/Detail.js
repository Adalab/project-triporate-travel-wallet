...
class Detail extends React.Component {
  ...
  render() {
    ...
    return (
        <React.Fragment>
          <Switch>
            {/* <Route  path = "/" render = {routerProps => (<Back 
            getInputFile = {this.getInputFile}
            />)}/> */}
            <Route path = {`/:${id}`} render = {routerProps => (<QrDetail 
            getInputFile = {this.getInputFile}
            routerProps = {routerProps}
            />)}/>
            <Route  path = {`/back/:${id}`} render = {routerProps => (<Back 
            getInputFile = {this.getInputFile}
            routerProps = {routerProps}
            />)}/>
          ...
          <div className="detail">     
            ...
            <div className="detail__user-name">
              ...
              <div className="detail__qr-wrapper">
                ...
                <Link className="link-qr" to = {`qrdetail/${id}`}>    
