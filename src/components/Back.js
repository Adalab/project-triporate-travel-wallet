              ...
              <div className="back__info-wrapper">
                <div className="back__card">
                  ...
                  <div className="back__user-name">
                    ...
                    <p className="user__gatehour-content">
                      {boardingPass.price}
                    </p>
                  </div>
                </div>
